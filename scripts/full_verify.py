...
# 6. Admin account
print('\n[6] Admin account:')
out, _ = run('docker exec freecdn-mysql mysql -ufreecdn -pfreecdn_pass_2026 freecdn -sNe "SELECT username, (password=\'0bab18d55a860df6d4ab91d32acf0542\') as pwd_ok, state, canLogin FROM edgeAdmins WHERE username=\'admin\';" 2>/dev/null')
