...
# 插入测试 DNS 域名（使用正确字段）
print("=== 插入测试 DNS 域名 ===")
r = run("mysql -h 127.0.0.1 -u freecdn -p'REDACTED_SSH_PASS' freecdn -e \"INSERT INTO edgeDNSDomains (adminId, name, state, createdAt, isOn, isUp, isDeleted) VALUES (1, 'test.example.com', 1, UNIX_TIMESTAMP(), 1, 1, 0);\" 2>&1")
print(r or "OK")
